...
information.
  ...
  - A very interesting idea is to instead use the `owl:versionInfo` predicate 
  to reference richer meta-data for each vocabulary change, e.g:
...
- Kurt Cagle provides an interesting example of versioning in this
  ...
  from Feb 2021. Here he uses UUID-based subject IRIs to refer to immutable
  ...
  interesting use of mixing human-friendly and UUID-based IRIs.  
